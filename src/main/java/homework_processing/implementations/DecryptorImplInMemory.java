...
public class DecryptorImplInMemory implements Decryptor {
    @Override
    public void decrypt(byte[] message) throws DiscardException, UnknownHostException {
        ...
        Processor processor = new ProcessorImplInMemory(new EncryptorImpl(new MessageWrapperImpl(CRCCalculatorImplementation.provide())));
